...
import CategoryImage from "../../../public/images/categories/development.jpg";
        ...
        <>
            ...
            >
                <div className="flex items-center justify-between">
                    <SectionTitle className={""}>Categories</SectionTitle>
            ...
            >
                <div className="flex items-center justify-between">
                    <SectionTitle className={""}>Courses</SectionTitle>
                    <Link
                        href={"/courses"}
                        className=" text-sm font-medium  hover:opacity-80 flex items-center gap-1"
                    >
